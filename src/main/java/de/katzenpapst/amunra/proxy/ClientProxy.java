...
public class ClientProxy extends ARSidedProxy {
    ...
    public void preInit(final FMLPreInitializationEvent event) {
         ...
         * super.preInit(event); for (IPlanetsModuleClient module : GalacticraftPlanets.clientModules.values()) {
    ...
    public static void registerItemRenderers() {
        ...
        MinecraftForgeClient.registerItemRenderer(
                Item.getItemFromBlock(ARBlocks.blockShuttleDock.getBlock()),
                new ItemRendererSpecial1());
    ...
    public static void registerEntityRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                EntityShuttle.class,
                new RenderShuttle(rocketModel, AmunRa.ASSETPREFIX, "shuttle"));
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
                ...
                new RenderMothershipJet(
                        engineModelIon,
                        new ResourceLocation(AmunRa.ASSETPREFIX, "textures/model/jet-ion.png"))); // for now
        ClientRegistry.bindTileEntitySpecialRenderer(
