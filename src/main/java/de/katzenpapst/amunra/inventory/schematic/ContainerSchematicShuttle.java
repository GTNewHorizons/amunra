...
public class ContainerSchematicShuttle extends Container {
    ...
    public static final int[][] slotCoordinateMapping = { { 48, 18 }, { 30, 36 }, { 48, 36 }, { 66, 36 }, { 30, 54 },
            { 48, 54 }, { 66, 54 }, { 30, 72 }, { 48, 72 }, { 66, 72 }, { 12, 90 }, { 30, 90 }, { 48, 90 }, { 66, 90 },
            { 84, 90 }, { 12, 108 }, { 48, 108 }, { 84, 108 },
    ...
    public ContainerSchematicShuttle(final InventoryPlayer player, final int x, final int y, final int z) {
        ...
        this.addSlotToContainer(
                new SlotRocketBenchResult(player.player, this.craftMatrix, this.craftResult, 0, 142, 18 + 69 + change));
        int slotX;
        int slotY;
        ...
        for (slotX = 0; slotX < 3; ++slotX) {
            for (slotY = 0; slotY < 9; ++slotY) {
                this.addSlotToContainer(
                        new Slot(player, slotY + slotX * 9 + 9, 8 + slotY * 18, 129 + slotX * 18 + change));
            }
        }
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index < numSlotsAdded) {
                ...
                for (int i = 0; i < numSlotsAdded; i++) {
                    ...
                    // attempt merge
                    if ((curSlot instanceof SlotSpecific && curSlot.isItemValid(stack))
